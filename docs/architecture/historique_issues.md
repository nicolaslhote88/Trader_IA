...
**Constat 2026-03-02** : `AG4-SPE-V2/AG4-SPE-V2-workflow.json` pesait 4 octets (BOM + newline).
**Workaround initial** : régénérer via `python AG4-SPE-V2/build_workflow.py`.
...
### ❌ 4. Duplication de `_news_pill_html` dans `dashboard/app.py`
