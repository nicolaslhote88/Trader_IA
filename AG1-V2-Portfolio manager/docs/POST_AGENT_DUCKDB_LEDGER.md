...
- `AG1-V2-Portfolio manager/sql/portfolio_ledger_schema_v2.sql`
- `AG1-V2-Portfolio manager/nodes/post_agent/duckdb_writer.py`
- `AG1-V2-Portfolio manager/nodes/post_agent/08_build_duckdb_bundle.code.js`
- `AG1-V2-Portfolio manager/nodes/post_agent/09_upsert_run_bundle_duckdb.code.py`
- `AG1-V2-Portfolio manager/nodes/post_agent/10_post_run_health.code.py`
...
- Note: the current workflow code still uses legacy fallback defaults under `/files/AG1-V2-EXPORT/...`.
...
```bash
python AG1-V2-Portfolio manager/nodes/post_agent/duckdb_writer.py init-schema --db /files/duckdb/ag1_v2.duckdb
python AG1-V2-Portfolio manager/nodes/post_agent/duckdb_writer.py upsert-run-bundle --db /files/duckdb/ag1_v2.duckdb --bundle-file /tmp/bundle.json
python AG1-V2-Portfolio manager/nodes/post_agent/duckdb_writer.py compute-snapshots --db /files/duckdb/ag1_v2.duckdb --run-id RUN_20260219_101500_ab12cd34
```
