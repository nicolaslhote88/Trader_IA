#!/usr/bin/env python3
"""
AG2-V3 workflow sync utility.

Canonical source:
- AG2-V3 - Analyse technique.json

This script can:
1) Print/export the canonical workflow JSON
2) Synchronize node source files (AG2-V3/nodes/*) from code nodes embedded in the canonical workflow
...
NODES_DIR = DIR / "nodes"
CANONICAL_FILE = DIR / "AG2-V3 - Analyse technique.json"
...
def main() -> None:
    ...
    parser.add_argument(
        "--sync-nodes",
        action="store_true",
        help="Sync AG2-V3/nodes/* from canonical workflow code nodes",
    )
