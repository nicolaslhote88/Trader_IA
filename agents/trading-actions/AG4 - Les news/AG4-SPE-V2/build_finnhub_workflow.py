#!/usr/bin/env python3
"""Reconstruit AG4_Spé-Finnhub-V1 avec l'analyse DeepSeek structurée."""
...
OUTPUT = ROOT / "AG4-SPE-FINNHUB-V1-workflow.json"
...
def build(source: Path) -> dict:
    ...
    if LEGACY_PARSE in code:
        ...
        raise RuntimeError("Hook de parsing S20 Finnhub absent")
