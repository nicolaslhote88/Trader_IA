...
for (const it of incoming) {
  ...
  if (!out.meta) out.meta = pickObject(j, ["meta", "Meta"]);
...
if (!out.config) out.config = { strategyVersion: out.run.strategyVersion || "strategy_v4_consensus", configVersion: out.run.configVersion || "ag1_v4_consensus_v1", promptVersion: out.run.promptVersion || "prompt_v4_consensus" };
...
out.run = { ...out.run, strategyVersion: out.run.strategyVersion || out.config.strategyVersion || "strategy_v4_consensus", configVersion: out.run.configVersion || out.config.configVersion || "ag1_v4_consensus_v1", promptVersion: out.run.promptVersion || out.config.promptVersion || "prompt_v4_consensus", model: out.run.model || "ag1_v4_consensus", universe_scope: universeScope, inputSnapshot };
