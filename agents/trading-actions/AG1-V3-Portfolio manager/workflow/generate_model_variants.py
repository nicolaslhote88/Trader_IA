...
LAYOUT_OVERRIDES = {
    "chatgpt52_current": {
        "positions": {
            ...
            "07b - IBKR Send Orders": [47056, 18608],
            "8 - Build DuckDB Bundle": [47280, 18608],
            "9 - Upsert Run Bundle (DuckDB)": [47504, 18608],
            "10 - Post-Run Health (DuckDB)": [47696, 18608],
    ...
    "grok41_reasoning_current": {
        "positions": {
            ...
            "07b - IBKR Send Orders": [55616, 59200],
            "8 - Build DuckDB Bundle": [55840, 59200],
            "9 - Upsert Run Bundle (DuckDB)": [56064, 59200],
            "10 - Post-Run Health (DuckDB)": [56256, 59200],
    ...
    "gemini30_pro_current": {
        "positions": {
            ...
            "07b - IBKR Send Orders": [5584, 21312],
            "8 - Build DuckDB Bundle": [5808, 21312],
            "9 - Upsert Run Bundle (DuckDB)": [6032, 21312],
            "10 - Post-Run Health (DuckDB)": [6224, 21312],
