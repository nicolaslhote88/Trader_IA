...
return [{
  json: {
    ...
    impact_region: j.impact_region || '',
    impact_asset_class: j.impact_asset_class || '',
    impact_magnitude: j.impact_magnitude || '',
    impact_fx_pairs: j.impact_fx_pairs || '',
    tagger_version: j.tagger_version || '',
