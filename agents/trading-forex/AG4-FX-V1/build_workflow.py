...
def build():
    nodes = [
        {
            # Every 4h before AG3-FX so AG1 reads a fresh macro digest.
            "parameters": {"rule": {"interval": [{"field": "cronExpression", "expression": "10 0,4,8,12,16,20 * * 1-5"}]}},
        ...
        node("03b Pull Official FX Sources", "03b_pull_official_fx_sources.py", 60, -20),
        node("04 Dedupe And Score", "04_dedupe_and_score.py", 300, -20),
        node("05 Compute FX Macro Digest", "05_compute_fx_macro_digest.py", 540, -20),
        node("06 Write Digest FX", "06_write_digest_fx.py", 780, -20),
        node("07 Log Run FX", "07_log_run_fx.py", 1020, -20),
    ]
