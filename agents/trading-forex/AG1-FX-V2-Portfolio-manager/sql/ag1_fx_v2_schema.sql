...
CREATE TABLE IF NOT EXISTS cfg.portfolio_config (
    ...
    leverage_max            DOUBLE NOT NULL DEFAULT 2.0,
    ...
    three_pillars_threshold DOUBLE NOT NULL DEFAULT 0.20,
    volatility_target_pct   DOUBLE NOT NULL DEFAULT 0.12,
...
CREATE TABLE IF NOT EXISTS core.runs (
    ...
    pillar_rejected_count   INTEGER,
    crowded_rejected_count  INTEGER,
...
CREATE TABLE IF NOT EXISTS core.ai_signals (
    ...
    macro_signal        DOUBLE,
    valuation_signal    DOUBLE,
    positioning_signal  DOUBLE,
    all_pillars_aligned BOOLEAN,
    created_at          TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);
...
INSERT INTO cfg.portfolio_config (
    ...
    kill_switch_active, three_pillars_threshold, volatility_target_pct,
    universe_filter, notes
)
SELECT 'default', 'unset', 10000, 2.0, 0.20, 0.20, 0.50, 0.05, FALSE, 0.20, 0.12,
    'forex_g10', 'Seeded by ag1_fx_v2_schema — Framework 3 Piliers Global Macro'
...
SELECT 'INITIAL_DEPOSIT', NULL, CURRENT_TIMESTAMP, 'deposit', 10000, 10000, NULL,
    'Initial AG1-FX-V2 sandbox capital — Global Macro 3 Piliers'
