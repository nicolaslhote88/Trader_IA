...
schema_path = ctx.get("schema_path") or "/files/AG1-FX-V2-EXPORT/sql/ag1_fx_v2_schema.sql"
...
with duckdb.connect(db_path) as con:
    ...
    leverage_max = max(0.01, to_float(cfg.get("leverage_max"), 2.0))
...
state = {
    ...
    "daily_pnl_eur": equity - day_start,
    "nav_eur": equity,
    "valuation_source": "live_recomputed_from_ag2_prices",
