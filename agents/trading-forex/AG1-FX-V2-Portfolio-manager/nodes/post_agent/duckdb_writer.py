...
DEFAULT_DB = os.getenv("AG1_FX_V2_CHATGPT52_DUCKDB_PATH", "/files/duckdb/ag1_fx_v2_chatgpt52.duckdb")
DEFAULT_SCHEMA = os.getenv("AG1_FX_V2_LEDGER_SCHEMA_PATH", "/files/AG1-FX-V2-EXPORT/sql/ag1_fx_v2_schema.sql")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="AG1-FX-V2 DuckDB helper")
