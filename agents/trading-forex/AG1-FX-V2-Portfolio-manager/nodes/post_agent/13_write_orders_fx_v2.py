    ...
    for o in orders:
        con.execute(
            ...
            INSERT INTO core.orders (
              order_id, client_order_id, run_id, pair, side, intent, order_type, size_lots,
              notional_quote, notional_eur, leverage_used, limit_price, stop_loss_price,
              take_profit_price, three_pillars_check, requested_at, status, rejection_reason,
              risk_check_passed, risk_check_notes
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT (order_id) DO UPDATE SET
              ...
              three_pillars_check = excluded.three_pillars_check,
            ...
            [
                ...
                o.get("intent"), o.get("order_type") or "market", float(o.get("size_lots") or 0),
                ...
                o.get("take_profit_price"), o.get("three_pillars_check") or "unknown",
                now_ts, o.get("status"), o.get("rejection_reason"),
