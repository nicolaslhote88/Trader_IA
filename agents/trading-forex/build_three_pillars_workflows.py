...
WORKFLOWS = [
    {"id": "AG5FXMacroPillarsV1", "name": "AG5 — Macro & Flows V2", "cron": "20 7 * * 1-5", "url": "={{ ($env.MACRO_DATA_API_URL || 'http://macro-data-api:8081') + '/components/ag5/refresh?refresh_sources=true' }}", "kind": "component", "legacy": "AG5-FX-Macro/workflow/AG5-FX-Macro_workflow_v1.json", "common": "AG5-Macro/AG5-Macro-V2-workflow.json"},
    {"id": "AG6FXValuationPillarsV1", "name": "AG6 — FX Relative Valuation V2", "cron": "40 7 * * 1-5", "url": "={{ ($env.MACRO_DATA_API_URL || 'http://macro-data-api:8081') + '/components/ag6/compute' }}", "kind": "component", "legacy": "AG6-FX-Valuation/workflow/AG6-FX-Valuation_workflow_v1.json", "common": "AG6-FX-Valuation/AG6-FX-Valuation-V2-workflow.json"},
    {"id": "AG7FXPositioningPillarsV1", "name": "AG7 — Positioning V2", "cron": "0 8 * * 1-5", "url": "={{ ($env.MACRO_DATA_API_URL || 'http://macro-data-api:8081') + '/components/ag7/refresh?refresh_source=true' }}", "kind": "component", "legacy": "AG7-FX-Positioning/workflow/AG7-FX-Positioning_workflow_v1.json", "common": "AG7-Positioning/AG7-Positioning-V2-workflow.json"},
    {"id": "AG8FXRatesPillarsV1", "name": "AG8 — Rates & Liquidity V2", "cron": "20 8 * * 1-5", "url": "={{ ($env.MACRO_DATA_API_URL || 'http://macro-data-api:8081') + '/components/ag8/compute' }}", "kind": "component", "legacy": "AG8-FX-Rates/workflow/AG8-FX-Rates_workflow_v1.json", "common": "AG8-Rates-Liquidity/AG8-Rates-Liquidity-V2-workflow.json"},
    ...
    {"id": "GLOBALCONTEXTSYNTH20260805", "name": "Global Context — AG5-AG9 Synthesizer", "cron": "5 10,13,16 * * 1-5", "url": "={{ ($env.GLOBAL_CONTEXT_SYNTHESIZER_URL || 'http://global-context-synthesizer:8083') + '/synthesize' }}", "kind": "snapshot", "common": "Global-Context-Synthesizer/Global-Context-Synthesizer-V1-workflow.json"},
]
